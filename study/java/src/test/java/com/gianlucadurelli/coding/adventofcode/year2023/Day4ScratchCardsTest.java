...
public class Day4ScratchCardsTest extends TestCase {
    ...
    private static final List<String> TEST_INPUT = AdventOfCodeTestHelpers.loadTestInput(Day4ScratchCards.class);
    private static final List<String> INPUT = AdventOfCodeTestHelpers.loadInput(Day4ScratchCards.class);
