...
def test_example():
    inputTxt = read_input_2022('day3_example.txt')
    solution = solve_day3_part1(inputTxt.splitlines())
    assert solution == 157

def test_case_1():
    inputTxt = read_input_2022('day3.txt')
    solution = solve_day3_part1(inputTxt.splitlines())
    assert solution == 7889

def test_example_2():
    inputTxt = read_input_2022('day3_example.txt')
    solution = solve_day3_part2(inputTxt.splitlines())
    assert solution == 70
